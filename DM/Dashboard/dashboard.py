...
with tab1:
    ...
    st.write("🗂️ Dataset Original (Belum Preprocessing) `data_mahasiswa_risk.csv`")
    if df_original is not None:
        st.dataframe(df_original.head())

    st.markdown("---")

    st.write("🗂️ Dataset Hasil Preprocessing (Clustered) `cluster_.csv`")
...
with tab4:
    ...
    **Insight:**
    - Faktor seperti **IPK**, **Kehadiran**, dan **Aktivitas Online** sangat berpengaruh terhadap prediksi.
